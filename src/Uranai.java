  ...
  public void Aquarius( int num ){
    ...
    switch( num ){
      case 1:
        ...
        break;
      case 2:
        System.out.println("眠っていた才能が開花。苦手意識を持たず挑戦。");
        System.out.println("ラッキーポイント『知り合いのブログ』");
        System.out.println("ただし浮かれすぎるのもNG");
        break;
      case 3:
        System.out.println("努力が実を結び目標達成。こだわりを持った行動を");
        System.out.println("ラッキーポイント『ＶネックＴシャツ』");
        System.out.println("ただし浮かれすぎるのもNG");
        break;
      case 4:
        System.out.println("作業がスムーズに進行♪チームワークを意識して。");
        System.out.println("ラッキーポイント『間違い探しゲーム』");
        System.out.println("ただし浮かれすぎるのもNG");
        break;
      case 5:
        System.out.println("長年の計画がついに実現。最新情報を有効活用して。");
        System.out.println("ラッキーポイント 『甘栗』");
        System.out.println("ただし浮かれすぎるのもNG");
        break;
      case 6:
        System.out.println("片思いの恋に嬉しい展開。前向きな姿勢でアタック。");
        System.out.println("ラッキーポイント『クリームチーズ』");
        System.out.println("ただし浮かれすぎるのもNG");
        break;
      case 7:
        System.out.println("価値観の違いで問題発生。相手の気持ちも理解して。");
        System.out.println("ラッキーポイント『麻のジャケット』");
        System.out.println("ただし神社にお賽銭、２４時間テレビに募金、被災地に募金すれば運気アップ！！");
        break;
      case 8:
        System.out.println("口が滑って思わぬ失敗。言葉のチョイスに注意。");
        System.out.println("ラッキーポイント『黒いヘアピン』");
        System.out.println("ただし神社にお賽銭、２４時間テレビに募金、被災地に募金すれば運気アップ！！");
        break;
      case 9:
        System.out.println("不測の事態が続出しそう。電話の置き忘れに要注意。");
        System.out.println("ラッキーポイント『新刊本』");
        System.out.println("ただし神社にお賽銭、２４時間テレビに募金、被災地に募金すれば運気アップ！！");
        break;
      case 10:
        System.out.println("他人に振り回され大混乱。怒らずに冷静さを保って。");
        System.out.println("ラッキーポイント『ファッション雑誌』");
        System.out.println("ただし神社にお賽銭、２４時間テレビに募金、被災地に募金すれば運気アップ！！");
        break;
      case 11:
        System.out.println("ウソを見抜けずにトラブル。直感に頼るのはホドホドに。");
        System.out.println("ラッキーポイント『家計簿アプリ』");
        System.out.println("ただし神社にお賽銭、２４時間テレビに募金、被災地に募金すれば運気アップ！！");
        break;
      case 12:
        System.out.println("おとめ座、積極的すぎる行動で周囲から孤立。興味本位で話しかけるのは控えて。");
